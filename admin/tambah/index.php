    ...
    <script>
        $(document).ready(function() {
            $('#addArticleForm').submit(function(e) {
                ...
                $.ajax({
                    url: 'http://localhost:8888/crud-php/rest-api/create.php',
                    type: 'POST',
                    data: formData,
                    contentType: false,
                    processData: false,
                    success: function(response) {
                        ...
                        alert('Kampus Toraja berhasil ditambahkan.');
...
<body class="max-w-screen-xl items-center justify-between mx-auto my-4">
    ...
    <form id="addArticleForm" enctype="multipart/form-data" class="my-8">
        ...
        <div class="mb-6">
            ...
            <input id="title" name="title" class="shadow-sm bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500 dark:shadow-sm-light" placeholder="Universitas DIPA Makassar" required>
        </div>
